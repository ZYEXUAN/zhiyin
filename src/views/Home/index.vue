<template>
  <div class="home">
    ...
    <div class="nav_content">
      <div class="nav_left">
        <div class="l_con">
          <img src="../../assets/icon/icon.b72a7a04.png" alt="" />
        </div>
      </div>
          ...
          <div class="home_recommend_comics threeClassic">
            ...
            <div class="home_recommend_comic">
              <div class="comic_cover_container" style="width: 100%;">
                <div
                  class="comic_cover"
                  data-src="https://img.manhua.weibo.com/client/2020/04/13/U7BV1BOY.jpg"
                  lazy="loaded"
            ...
            <div class="home_recommend_comic">
              <div class="comic_cover_container" style="width: 100%;">
                <div
                  class="comic_cover"
                  data-src="https://img.manhua.weibo.com/client/2020/02/11/4OUmhN18.jpg"
                  lazy="loaded"
          ...
          <div class="home_recommend_comics fourClassic">
            <div class="home_recommend_comic">
              <div class="comic_cover_container" style="width: 100%;">
                <div
                  class="comic_cover"
                  data-src="https://img.manhua.weibo.com/client/2019/02/12/c0C6DGjZ.jpg"
                  lazy="loaded"
            ...
            <div class="home_recommend_comic">
              <div class="comic_cover_container" style="width: 100%;">
                <div
                  class="comic_cover"
                  data-src="https://img.manhua.weibo.com/client/2020/04/20/f4GWamfV.jpg"
                  lazy="loaded"
